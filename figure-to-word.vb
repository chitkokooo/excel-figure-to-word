...
'
' Just call ConvertFigureToWord(number_arg) from excel cell,
' where number_arg is desired number(figure) to print out text(word)
'
' ******************************************************************


'for example 123.45 => kyats- tis yar hnis sal thone pyas- lay sal ngar titi
Function ConvertFigureToWord(numbers)
